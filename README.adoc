...
:experimental:
:url-github: https://github.com/hyperpolymath/nano-ruber
:url-gitlab: https://gitlab.com/hyperpolymath/nano-ruber
:url-bitbucket: https://bitbucket.org/hyperpolymath/nano-ruber
:url-codeberg: https://codeberg.org/hyperpolymath/nano-ruber

Nano-scale rubber band simulation engine
...
nano-ruber is part of the link:https://rhodium.sh[Rhodium Standard] (RSR) ecosystem.
